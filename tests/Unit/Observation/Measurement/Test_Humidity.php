...
/**
 * Tests for Base_Measurement used as humidity type.
 *
 * @since 0.1.0
 *
...
class Test_Humidity extends \WP_UnitTestCase {
	 ...
	 * @covers \PinkCrab\Ecowitt_Weather_Block\Observation\Measurement\Base_Measurement::get_type
	 */
	public function test_returns_correct_measurement_type(): void {
		$measurement_dto = new Measurement( '65', '%', '1642248600' );
		$humidity        = new Base_Measurement( $measurement_dto, Base_Measurement::TYPE_HUMIDITY );
