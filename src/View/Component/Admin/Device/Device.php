...
class Device extends Component implements \JsonSerializable {
	 ...
	 */
	public function __construct( DeviceDTO $device, Connection $connection ) {
		$this->device       = $device;
		$this->id           = $device->id;
	...
	public function creation_date(): string {
		...
		return wp_date( Utils::get_datetime_format(), $this->createtime ) ?: '';
	}
