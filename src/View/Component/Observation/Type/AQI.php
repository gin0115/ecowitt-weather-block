...
class AQI extends Component {
	...
	/**
	 * Creates an instance of the AQI Component.
	 *
	 * @param Base_Measurement $measurement AQI measurement instance
	 * @param string $label AQI label
	 */
