...
/**
 * The voltage measurement component.
 *
 * @since 0.1.0
 */
...
class Voltage extends Component {
	...
	/**
	 * Creates an instance of the Voltage Component.
	 *
	 * @param Base_Measurement $measurement Voltage measurement instance
	 * @param string $label Voltage label
	 */
