...
/**
 * The rainfall measurement component.
 *
 * @since 0.1.0
 */
 ...
 * The rainfall measurement component.
 *
 * @view observation.type.rainfall
 */
class Rainfall extends Component {
	 ...
	 *
	 * @param Base_Measurement $measurement Rainfall measurement instance
	 * @param string $label Rainfall label
	 */
