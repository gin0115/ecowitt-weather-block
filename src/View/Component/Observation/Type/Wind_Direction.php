...
/**
 * The wind direction measurement component.
 *
 * @since 0.1.0
 */
 ...
 * The wind direction measurement component.
 *
 * @view observation.type.wind_direction
 */
class Wind_Direction extends Component {
	...
	/**
	 * Creates an instance of the Wind_Direction Component.
	 *
	 * @param Base_Measurement $measurement Wind direction measurement instance
	 * @param string $label Wind direction label
	 */
