...
/**
 * The count measurement component.
 *
 * @since 0.1.0
 */
...
class Count extends Component {
	...
	/**
	 * Creates an instance of the Count Component.
	 *
	 * @param Base_Measurement $measurement Count measurement instance
