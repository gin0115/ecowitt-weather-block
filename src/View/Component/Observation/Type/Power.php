...
/**
 * The power measurement component.
 *
 * @since 0.1.0
 */
...
class Power extends Component {
	...
	/**
	 * Creates an instance of the Power Component.
	 *
	 * @param Base_Measurement $measurement Power measurement instance
	 * @param string $label Power label
	 */
