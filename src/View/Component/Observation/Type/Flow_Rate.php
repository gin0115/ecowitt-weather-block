...
/**
 * The flow rate measurement component.
 *
 * @since 0.1.0
 */
 ...
 * The flow rate measurement component.
 *
 * @view observation.type.flow_rate
 */
class Flow_Rate extends Component {
	...
	/**
	 * Creates an instance of the Flow_Rate Component.
	 *
	 * @param Base_Measurement $measurement Flow rate measurement instance
	 * @param string $label Flow rate label
	 */
