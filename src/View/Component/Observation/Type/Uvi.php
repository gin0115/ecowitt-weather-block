...
/**
 * The UV index measurement component.
 *
 * @since 0.1.0
 */
 ...
 * The UV index measurement component.
 *
 * @view observation.type.uvi
 */
class Uvi extends Component {
	...
	/**
	 * Creates an instance of the Uvi Component.
	 *
	 * @param Base_Measurement $measurement UV index measurement instance
	 * @param string $label UV index label
	 */
