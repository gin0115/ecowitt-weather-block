...
/**
 * The wind speed measurement component.
 *
 * @since 0.1.0
 */
 ...
 * The wind speed measurement component.
 *
 * @view observation.type.wind_speed
 */
class Wind_Speed extends Component {
	...
	/**
	 * Creates an instance of the Wind_Speed Component.
	 *
	 * @param Base_Measurement $measurement Wind speed measurement instance
	 * @param string $label Wind speed label
	 */
