...
/**
 * The rain rate measurement component.
 *
 * @since 0.1.0
 */
 ...
 * The rain rate measurement component.
 *
 * @view observation.type.rain_rate
 */
class Rain_Rate extends Component {
	...
	/**
	 * Creates an instance of the Rain_Rate Component.
	 *
	 * @param Base_Measurement $measurement Rain rate measurement instance
	 * @param string $label Rain rate label
	 */
