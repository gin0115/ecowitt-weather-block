...
/**
 * The battery measurement component.
 *
 * @since 0.1.0
 */
...
class Battery extends Component {
	 ...
	 *
	 * @param Base_Measurement $measurement Battery measurement instance
	 * @param string $label Battery label
	 */
