...
/**
 * The temperature measurement component.
 *
 * @since 0.1.0
 */
 ...
 * The temperature measurement component.
 *
 * @view observation.type.temperature
 */
class Temperature extends Component {
	...
	/**
	 * Creates an instance of the Temperature Component.
	 *
	 * @param Base_Measurement $measurement Temperature measurement instance
	 * @param string $label Temperature label
	 */
