...
/**
 * The Air Quality measurement component.
 *
 * @since 0.1.0
 */
 ...
 * The Air Quality measurement component.
 *
 * @view observation.type.air_quality
 */
class Air_Quality extends Component {
	...
	/**
	 * Creates an instance of the Air_Quality Component.
	 *
	 * @param Base_Measurement $measurement Air Quality measurement instance
	 * @param string $label Air Quality label
	 */
