...
/**
 * Component: Indoor CO2 Measurements
 *
...
<div class="measurement-section mb-lg">
	<div class="device__header">
		<h5 class="device__title text-lg pb-sm">
			<?php esc_html_e( 'Indoor CO2', 'pinkcrab-weather-block' ); ?>
		</h5>
	</div>
	...
	<div class="measurement-section__content">
		...
		<?php else : ?>
			<div class="observation-placeholder">
				<p><?php esc_html_e( 'No indoor CO2 measurement data available.', 'pinkcrab-weather-block' ); ?></p>
			</div>
		<?php endif; ?>
	</div>
</div>
